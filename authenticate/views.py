...
from .forms import CustomUserCreationForm, CustomLoginForm, AdminPasswordChangeForm, CustomUserUpdateForm
...
def edit_user(request, user_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('user_record')  # Redirect after successful edit
    else:
